<template>
  <div v-if="totalPages > 1" class="pagination_wrapper">
    <button :disabled="props.currentPage === 1" @click="firstPage">
      <Icon name="Left-dbl" :size="26" />
    </button>
    <button :disabled="props.currentPage === 1" @click="prevPage">
    ...
    <button :disabled="props.currentPage === totalPages" @click="nextPage">
      <Icon name="Right" :size="26" />
    </button>
    <button :disabled="props.currentPage === totalPages" @click="lastPage">
