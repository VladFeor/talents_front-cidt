  ...
  <div>
    <div class="multiselect-with-tags" ref="multiselectContainer">
      <div class="selected-tags">
        ...
        <div class="arrow" @click="toggle" v-if="!blocked">
      ...
      <div class="options" v-show="open">
        <div class="search-container">
          ...
          <input
            ...
            @blur="touched = true"
            @focus="touched = false"
            :placeholder="placeholder || 'Find language..'"
          />
        </div>
        <div
        ...
        >
          {{ reduceStringLength(option.name, 18) }}
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const removeTag = (index) => {
      emit('removed-item', selectedItems.value[index]);
      removedItems.value.push(selectedItems.value[index]);
      selectedItems.value.splice(index, 1);
      emit('removed-items', removedItems.value);
    ...
    watch(
      ...
      () => {
        selectedItems.value = [...props.initialSelectedItems];
      },
    );
    onMounted(() => {
